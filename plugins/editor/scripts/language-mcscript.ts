...
CodeMirror.defineSimpleMode("mcscript", {
  start: [
    { regex: /black|§0|\\u00A70/gim, token: "style-black" },
    { regex: /dark_blue|§1|\\u00A71/gim, token: "style-dark_blue" },
    { regex: /dark_green|§2|\\u00A72/gim, token: "style-dark_green" },
    { regex: /dark_aqua|§3|\\u00A73/gim, token: "style-dark_aqua" },
    { regex: /dark_red|§4|\\u00A74/gim, token: "style-dark_red" },
    { regex: /dark_purple|§d|\\u00A7d/gim, token: "style-dark_purple" },
    { regex: /gold|§6|\\u00A76/gim, token: "style-gold" },
    { regex: /gray|§7|\\u00A77/gim, token: "style-gray" },
    { regex: /dark_gray|§8|\\u00A78/gim, token: "style-dark_gray" },
    { regex: /blue|§9|\\u00A79/gim, token: "style-blue" },
    { regex: /green|§a|\\u00A7a/gim, token: "style-green" },
    { regex: /aqua|§b|\\u00A7b/gim, token: "style-aqua" },
    { regex: /red|§c|\\u00A7c/gim, token: "style-red" },
    { regex: /light_purple|§d|\\u00A7d/gim, token: "style-light_purple" },
    { regex: /yellow|§e|\\u00A7e/gim, token: "style-yellow" },
    { regex: /white|§f|\\u00A7f/gim, token: "style-white" },
    { regex: /reset|§r|\\u00A7r/gim, token: "style-reset" },
    { regex: /bold|§l|\\u00A7l/gim, token: "style-bold" },
    { regex: /underline|§n|\\u00A7n/gim, token: "style-underline" },
    { regex: /italic|§o|\\u00A7o/gim, token: "style-italic" },
    { regex: /strikethrough|§m|\\u00A7m/gim, token: "style-strikethrough" },
    { regex: /obfuscated|§k|\\u00A7k/gim, token: "style-obfuscated" },
  ...
  comment2: [
    ...
    {
      regex: new RegExp(`(@(${docTags.join("|")}))`),
      token: ["comment2_annountion"]
    },
