...
let keywords_1 = [
  ...
  "minecraft.custom:minecraft.dive_one_cm",
...
CodeMirror.defineSimpleMode("mcfunction", {
  start: [
    ...
    { regex: new RegExp("(?:" + atoms.join("|") + ")", "g"), token: "atom" },
    { regex: number, token: "number" },
    { regex: /(^|\r|\n)(\t| )*#(?:[^\r\n]|\r(?!\n))*/gm, token: "comment" },
    { regex: /[\[\]\{\}\(\)]/, token: "letiable" },
    { regex: /(@a|@e|@p|@r|@s)|[|]/, token: "letiable-2" },
    { regex: new RegExp(selectorkeywords.join("|"), "g"), token: "def" },
    { regex: new RegExp(keywords_1.join("|"), "g"), token: "bracket" },
    { regex: new RegExp(selectorkeywords.join("|"), "g"), token: "tag" },
    { regex: new RegExp(keywords_2.join("|"), "g"), token: "extra1" },
    { regex: new RegExp(keywords_3.join("|"), "g"), token: "extra2" },
    { regex: new RegExp(keywords_4.join("|"), "g"), token: "extra3" },
    { regex: /(\=|\-\=|\+\=|\/\=|\*\=|\<\=|\>\=|\.\.|\:)+/, token: "operator" },
    { regex: /[\{\[\(]/, indent: true },
    { regex: /[\}\]\)]/, dedent: true },

    // Colors
    { regex: /black|§0|\\u00A70/, token: "style-black" },
    { regex: /dark_blue|§1|\\u00A71/, token: "style-dark_blue" },
    { regex: /dark_green|§2|\\u00A72/, token: "style-dark_green" },
    { regex: /dark_aqua|§3|\\u00A73/, token: "style-dark_aqua" },
    { regex: /dark_red|§4|\\u00A74/, token: "style-dark_red" },
    { regex: /dark_purple|§d|\\u00A7d/, token: "style-dark_purple" },
    { regex: /gold|§6|\\u00A76/, token: "style-gold" },
    { regex: /gray|§7|\\u00A77/, token: "style-gray" },
    { regex: /dark_gray|§8|\\u00A78/, token: "style-dark_gray" },
    { regex: /blue|§9|\\u00A79/, token: "style-blue" },
    { regex: /green|§a|\\u00A7a/, token: "style-green" },
    { regex: /aqua|§b|\\u00A7b/, token: "style-aqua" },
    { regex: /red|§c|\\u00A7c/, token: "style-red" },
    { regex: /light_purple|§d|\\u00A7d/, token: "style-light_purple" },
    { regex: /yellow|§e|\\u00A7e/, token: "style-yellow" },
    { regex: /white|§f|\\u00A7f/, token: "style-white" },
    { regex: /reset|§r|\\u00A7r/, token: "style-reset" },
    { regex: /bold|§l|\\u00A7l/, token: "style-bold" },
    { regex: /underline|§n|\\u00A7n/, token: "style-underline" },
    { regex: /italic|§o|\\u00A7o/, token: "style-italic" },
    { regex: /strikethrough|§m|\\u00A7m/, token: "style-strikethrough" },
    { regex: /obfuscated|§k|\\u00A7k/, token: "style-obfuscated" }
  ],
  comment: [],
  meta: {}
});
